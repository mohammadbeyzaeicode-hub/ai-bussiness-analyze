...
from src.report import plot_monthly_trend, plot_top_products, build_html_report
...
def run_pipeline():
    ...
    try:
        prompt = build_analysis_prompt(stats, monthly, top_prods, anomalies, region_perf)
    ...
    report_path = build_html_report(stats, ai_text, chart1, chart2, region_perf)
